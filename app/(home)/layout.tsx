...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Header />
      <main className="flex flex-col md:flex-row gap-4 p-4 md:p-6 lg:px-8 max-md:mb-20">
        ...
        <div className="flex-1 text-center p-2 md:p-4 lg:p-6 bg-white dark:!bg-secondary-dark rounded-2xl border-gray-200 border-1 dark:border-0">
          {children}
        </div>

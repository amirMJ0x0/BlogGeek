...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted dark:bg-gray-700 text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 outline-1 rounded-md", className)}
      {...props}
    />
  );
}
